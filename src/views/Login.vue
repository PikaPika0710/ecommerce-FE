        ...
        <div class="col-lg-6">
          <div class="card2 card border-0 px-4 py-5">
            ...
            <div class="row px-3">
              ...
              <input class="mb-4" type="text" name="email" placeholder="Enter a valid email address" v-model="username">
            </div>
            <div class="row px-3">
              <label class="mb-1">
            ...
            <div class="row mb-3 px-3">
              <button type="submit" class="btn btn-blue text-center" @click="submitForm">Login</button>
            </div>
            <div class="row mb-4 px-3">
